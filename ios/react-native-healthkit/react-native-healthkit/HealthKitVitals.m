...
-(void)saveBloodGlucose:(HKHealthStore*) healthStore healthData:(NSDictionary*)data metadata:(NSDictionary*)metadata callback: (RCTResponseSenderBlock)callback{
    ...
    HKQuantitySample *bloodGlucoseSample = [HKQuantitySample quantitySampleWithType:bloodGlucoseType quantity:bloodGlucoseQuantity startDate:sampleDate endDate:sampleDate metadata:metadata];
